...
public:
    ...
    void setFps(int32_t num, int32_t den) { fpsNumerator_ = num > 0 ? num : 30; fpsDenominator_ = den > 0 ? den : 1; }
    ...
    void setBackgroundColor(const std::string& c) { backgroundColor_ = c; }
private:
    int32_t width_ = 1920, height_ = 1080, fpsNumerator_ = 30, fpsDenominator_ = 1;
    int64_t durationMs_ = 60000; std::string backgroundColor_ = "#000000FF";
};
}
